// 1. Handle Slider Control and Display Password Length 

// Targeting and storing value of the password length into a variable 
let lengthDisplay = document.querySelector('[lengthDisplay]');
// Targeting and storing value of the slider value  into a variable 
let slider = document.querySelector('input[type=range]');

//Creating a function to update the value of the slider to passwordLength attribute and then update it to the lengthDisplay variable
function handleSlider() {
    slider.value = passwordLength;
    lengthDisplay.innerText = passwordLength;
}

//Setting the default value of the passwordLength attribute to display and immediately calling the handleSlider() function to display the default value else it will not reflect any value in starting / default without calling the function
let passwordLength = 10;
handleSlider();

//Adding the event listener to the slider so that whenever the slider value is updated it updates the value to the passwordLength attribute
...
// passwordDisplay.value = "My Name is Ashish";
